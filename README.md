Класс для обработки текущего HTTP-запроса
=====================

Небольшой класс для упрощения работы с информацией о текущем запросе (суперглобальные массивы, заголовки, URL и прочее).
