 ...
 * 
 * @link https://github.com/programulin/request
 */
class Request
{
    ...
    array $get = null, array $post = null, array $files = null, array $server = null, array $cookie = null, array $headers = null)
    {
        ...
        $this->url = array_filter(explode('/', trim($url, '/')), function($var) {
            return $var !== '';
        });
    }
